...
public class FeatureUserRequest {
	...
	@ApiModelProperty(notes = "The name of the feature for which you want to check access of a certain user.", position = 0, required = true)
	@Valid
	@NotBlank(message = "Field featureName should be a non-blank value.")
	private String featureName;

	@ApiModelProperty(notes = "The email address of the user whose access you want to check against a certain feature.", position = 1, required = true)
	@Valid
	...
	@ApiModelProperty(notes = "The boolean flag that indicates if a certain user's access to a certain feature is enabled/disabled", position = 2, required = true)
	boolean enable;
